...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("socials_error.log"),
...
async def main():
    ...
    try:
        df = pd.read_csv("../data/pumpfun_creations.csv").head(1000)
        uris = df["uri"]
        ...
        extended_df.to_csv("../data/extended_data.csv", index=False)

        logging.info("Parsing completed successfully. Data saved to '../data/extended_data.csv'.")
